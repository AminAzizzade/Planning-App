...
class AppModule
{
    ...
    @Provides
    @Singleton
    fun provideProjectDescriptionRepository(dataSource: ProjectDescriptionDataSource): ProjectDescriptionRepository {
        return ProjectDescriptionRepository(dataSource)
    }

    @Provides
    @Singleton
    fun provideProjectDescriptionDataSource(projectDescriptionDAO: ProjectDescriptionDAO): ProjectDescriptionDataSource {
        return ProjectDescriptionDataSource(projectDescriptionDAO)
    }
    ...
    @Provides
    @Singleton
    fun provideProjectDescriptionDAO(@ApplicationContext context: Context): ProjectDescriptionDAO
    {
        val database = Room.databaseBuilder(context, Database::class.java, "planyourcareer.db")
            .createFromAsset("planyourcareer.db").build()
        return database.getProjectDescriptionDAO()
    }
}
